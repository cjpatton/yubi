...
configuration.) \cpnote{I'm not sure about Windows.} Second, it requires the
...
\cpnote{Organization of the rest of the write up: Section 2 describes the tokens
(YubiKey and YubiHSM) and their functionalities. Section 3 describes the
OTP protocol and its security. Section 4 presents OTP1, and Section 5 presents
OTP2 and applications.}
